...
<a><input type="radio" name="vastaus<%=i %>" id="inlineRadio1" value="1" required></a>
<label class="form-check-label" >Täysin eri mieltä</label>

</div>

<div class="vastauscont">
<input  type="radio" name="vastaus<%=i %>" id="inlineRadio2" value="2" >
<label class="form-check-label" >Jokseenkin eri mieltä</label>

</div>
<div class="vastauscont">
<input  type="radio" name="vastaus<%=i %>" id="inlineRadio3" value="3" >
<label class="form-check-label" >Ei mielipidettä</label>

</div>

<div class="vastauscont">

<input type="radio" name="vastaus<%=i %>" id="inlineRadio4" value="4">
<label class="form-check-label" >Jokseenkin samaa mieltä</label>
</div>

<div class="vastauscont">

<input type="radio" name="vastaus<%=i %>" id="inlineRadio5" value="5">
